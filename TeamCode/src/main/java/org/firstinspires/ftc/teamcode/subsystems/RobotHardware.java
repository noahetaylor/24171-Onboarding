 ...
 *
 * As mechanisms get added, their motors/servos get declared and initialized
 * here too, following the same pattern as the drive motors below.
 */
public class RobotHardware {
    ...
    public void init(HardwareMap hardwareMap) {
        // PLACEHOLDER NAMES — these strings must exactly match whatever you
        // name the motors in the Driver Station's robot configuration file
        // once there's a real Control Hub to configure. Rename here (and
        // only here) once that's set.
